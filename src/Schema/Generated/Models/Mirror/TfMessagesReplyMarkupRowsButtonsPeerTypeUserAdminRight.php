...
final class TfMessagesReplyMarkupRowsButtonsPeerTypeUserAdminRight extends TfChildModel
{
    use AccountScoped;

    protected $table = 'tf_messages_reply_markup_rows_buttons_peer_type_user_admin_rights';
