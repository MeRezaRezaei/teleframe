...
/**
 * Union DTO base for TL type AttachMenuBot.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAttachMenuBotAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'attachMenuBot' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\AttachMenuBotData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for AttachMenuBot');
