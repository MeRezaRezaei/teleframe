...
/**
 * Union DTO base for TL type StarsSubscription.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarsSubscriptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starsSubscription' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarsSubscriptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarsSubscription');
