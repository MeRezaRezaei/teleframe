...
/**
 * Union DTO base for TL type BotVerifierSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBotVerifierSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'botVerifierSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BotVerifierSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BotVerifierSettings');
