...
/**
 * Union DTO base for TL type SavedStarGift.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSavedStarGiftAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'savedStarGift' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SavedStarGiftData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SavedStarGift');
