...
/**
 * Union DTO base for TL type bots.RequestedButton.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBotsRequestedButtonAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'bots.requestedButton' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlBotsRequestedButtonData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for bots.RequestedButton');
