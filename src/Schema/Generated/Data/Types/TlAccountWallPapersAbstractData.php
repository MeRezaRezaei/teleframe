...
/**
 * Union DTO base for TL type account.WallPapers.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountWallPapersAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.wallPapers' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountWallPapersData::class,
        'account.wallPapersNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountWallPapersNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.WallPapers');
