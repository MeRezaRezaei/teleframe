...
/**
 * Union DTO base for TL type StarsTransaction.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarsTransactionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starsTransaction' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarsTransactionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarsTransaction');
