...
/**
 * Union DTO base for TL type WebViewMessageSent.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlWebViewMessageSentAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'webViewMessageSent' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\WebViewMessageSentData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for WebViewMessageSent');
