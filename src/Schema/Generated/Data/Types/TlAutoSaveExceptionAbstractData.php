...
/**
 * Union DTO base for TL type AutoSaveException.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAutoSaveExceptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'autoSaveException' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\AutoSaveExceptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for AutoSaveException');
