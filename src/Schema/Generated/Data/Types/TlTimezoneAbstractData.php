...
/**
 * Union DTO base for TL type Timezone.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlTimezoneAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'timezone' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TimezoneData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Timezone');
