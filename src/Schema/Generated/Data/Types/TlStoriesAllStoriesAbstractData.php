...
/**
 * Union DTO base for TL type stories.AllStories.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStoriesAllStoriesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stories.allStories' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStoriesAllStoriesData::class,
        'stories.allStoriesNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStoriesAllStoriesNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for stories.AllStories');
