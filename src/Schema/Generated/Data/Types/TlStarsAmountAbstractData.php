...
/**
 * Union DTO base for TL type StarsAmount.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarsAmountAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starsAmount' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarsAmountData::class,
        'starsTonAmount' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarsTonAmountData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarsAmount');
