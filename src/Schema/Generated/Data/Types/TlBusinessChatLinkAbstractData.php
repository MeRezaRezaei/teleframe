...
/**
 * Union DTO base for TL type BusinessChatLink.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBusinessChatLinkAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'businessChatLink' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BusinessChatLinkData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BusinessChatLink');
