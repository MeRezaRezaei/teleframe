...
/**
 * Union DTO base for TL type InlineBotWebView.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInlineBotWebViewAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inlineBotWebView' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InlineBotWebViewData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InlineBotWebView');
