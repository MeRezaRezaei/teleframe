...
/**
 * Union DTO base for TL type InputFolderPeer.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputFolderPeerAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputFolderPeer' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputFolderPeerData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputFolderPeer');
