...
/**
 * Union DTO base for TL type help.InviteText.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlHelpInviteTextAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'help.inviteText' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpInviteTextData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for help.InviteText');
