...
/**
 * Union DTO base for TL type BankCardOpenUrl.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBankCardOpenUrlAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'bankCardOpenUrl' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BankCardOpenUrlData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BankCardOpenUrl');
