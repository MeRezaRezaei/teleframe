...
/**
 * Union DTO base for TL type account.Authorizations.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountAuthorizationsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.authorizations' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountAuthorizationsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.Authorizations');
