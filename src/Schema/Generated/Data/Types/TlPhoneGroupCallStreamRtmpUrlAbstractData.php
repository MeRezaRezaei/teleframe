...
/**
 * Union DTO base for TL type phone.GroupCallStreamRtmpUrl.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPhoneGroupCallStreamRtmpUrlAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'phone.groupCallStreamRtmpUrl' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPhoneGroupCallStreamRtmpUrlData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for phone.GroupCallStreamRtmpUrl');
