...
/**
 * Union DTO base for TL type RestrictionReason.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlRestrictionReasonAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'restrictionReason' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\RestrictionReasonData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for RestrictionReason');
