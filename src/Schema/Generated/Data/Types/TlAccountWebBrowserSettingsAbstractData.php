...
/**
 * Union DTO base for TL type account.WebBrowserSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountWebBrowserSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.webBrowserSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountWebBrowserSettingsData::class,
        'account.webBrowserSettingsNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountWebBrowserSettingsNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.WebBrowserSettings');
