...
/**
 * Union DTO base for TL type stories.Albums.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStoriesAlbumsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stories.albums' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStoriesAlbumsData::class,
        'stories.albumsNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStoriesAlbumsNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for stories.Albums');
