...
/**
 * Union DTO base for TL type phone.GroupParticipants.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPhoneGroupParticipantsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'phone.groupParticipants' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPhoneGroupParticipantsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for phone.GroupParticipants');
