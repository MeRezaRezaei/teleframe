...
/**
 * Union DTO base for TL type Pong.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPongAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'pong' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PongData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Pong');
