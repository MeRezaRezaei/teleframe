...
/**
 * Union DTO base for TL type InputSecureValue.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputSecureValueAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputSecureValue' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputSecureValueData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputSecureValue');
