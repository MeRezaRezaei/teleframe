...
/**
 * Union DTO base for TL type MyBoost.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMyBoostAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'myBoost' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MyBoostData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MyBoost');
