...
/**
 * Union DTO base for TL type ChannelAdminLogEventsFilter.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChannelAdminLogEventsFilterAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'channelAdminLogEventsFilter' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChannelAdminLogEventsFilterData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChannelAdminLogEventsFilter');
