...
/**
 * Union DTO base for TL type StarGiftCollection.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarGiftCollectionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starGiftCollection' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarGiftCollectionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarGiftCollection');
