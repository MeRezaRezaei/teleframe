...
/**
 * Union DTO base for TL type ChatReactions.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatReactionsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatReactionsAll' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatReactionsAllData::class,
        'chatReactionsNone' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatReactionsNoneData::class,
        'chatReactionsSome' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatReactionsSomeData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChatReactions');
