...
/**
 * Union DTO base for TL type help.CountryCode.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlHelpCountryCodeAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'help.countryCode' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpCountryCodeData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for help.CountryCode');
