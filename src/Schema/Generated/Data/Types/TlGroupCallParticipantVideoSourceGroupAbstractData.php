...
/**
 * Union DTO base for TL type GroupCallParticipantVideoSourceGroup.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlGroupCallParticipantVideoSourceGroupAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'groupCallParticipantVideoSourceGroup' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GroupCallParticipantVideoSourceGroupData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for GroupCallParticipantVideoSourceGroup');
