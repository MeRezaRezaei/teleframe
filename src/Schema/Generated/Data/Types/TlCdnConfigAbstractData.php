...
/**
 * Union DTO base for TL type CdnConfig.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlCdnConfigAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'cdnConfig' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\CdnConfigData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for CdnConfig');
