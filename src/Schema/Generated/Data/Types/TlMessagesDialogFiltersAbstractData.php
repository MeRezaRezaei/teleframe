...
/**
 * Union DTO base for TL type messages.DialogFilters.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesDialogFiltersAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.dialogFilters' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesDialogFiltersData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.DialogFilters');
