...
/**
 * Union DTO base for TL type payments.BankCardData.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsBankCardDataAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.bankCardData' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsBankCardDataData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.BankCardData');
