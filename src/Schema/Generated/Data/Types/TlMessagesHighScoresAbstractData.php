...
/**
 * Union DTO base for TL type messages.HighScores.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesHighScoresAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.highScores' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesHighScoresData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.HighScores');
