...
/**
 * Union DTO base for TL type BotAppSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBotAppSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'botAppSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BotAppSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BotAppSettings');
