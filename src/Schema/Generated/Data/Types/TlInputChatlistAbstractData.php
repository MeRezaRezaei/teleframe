...
/**
 * Union DTO base for TL type InputChatlist.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputChatlistAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputChatlistDialogFilter' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputChatlistDialogFilterData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputChatlist');
