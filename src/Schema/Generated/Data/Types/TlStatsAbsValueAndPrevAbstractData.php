...
/**
 * Union DTO base for TL type StatsAbsValueAndPrev.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStatsAbsValueAndPrevAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'statsAbsValueAndPrev' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StatsAbsValueAndPrevData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StatsAbsValueAndPrev');
