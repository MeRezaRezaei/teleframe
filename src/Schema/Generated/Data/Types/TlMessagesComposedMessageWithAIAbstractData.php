...
/**
 * Union DTO base for TL type messages.ComposedMessageWithAI.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesComposedMessageWithAIAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.composedMessageWithAI' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesComposedMessageWithAIData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.ComposedMessageWithAI');
