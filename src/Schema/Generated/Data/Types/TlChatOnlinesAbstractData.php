...
/**
 * Union DTO base for TL type ChatOnlines.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatOnlinesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatOnlines' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatOnlinesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChatOnlines');
