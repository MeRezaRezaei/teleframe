...
/**
 * Union DTO base for TL type RecentStory.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlRecentStoryAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'recentStory' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\RecentStoryData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for RecentStory');
