...
/**
 * Union DTO base for TL type BotInfo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBotInfoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'botInfo' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BotInfoData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BotInfo');
