...
/**
 * Union DTO base for TL type account.ChatThemes.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountChatThemesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.chatThemes' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountChatThemesData::class,
        'account.chatThemesNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountChatThemesNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.ChatThemes');
