...
/**
 * Union DTO base for TL type messages.PeerDialogs.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesPeerDialogsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.peerDialogs' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesPeerDialogsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.PeerDialogs');
