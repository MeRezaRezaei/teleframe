...
/**
 * Union DTO base for TL type contacts.ContactBirthdays.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlContactsContactBirthdaysAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'contacts.contactBirthdays' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlContactsContactBirthdaysData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for contacts.ContactBirthdays');
