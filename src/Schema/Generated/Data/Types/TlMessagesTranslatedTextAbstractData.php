...
/**
 * Union DTO base for TL type messages.TranslatedText.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesTranslatedTextAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.translateResult' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesTranslateResultData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.TranslatedText');
