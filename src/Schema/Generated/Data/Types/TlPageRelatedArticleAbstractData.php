...
/**
 * Union DTO base for TL type PageRelatedArticle.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPageRelatedArticleAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'pageRelatedArticle' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PageRelatedArticleData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PageRelatedArticle');
