...
/**
 * Union DTO base for TL type messages.FeaturedStickers.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesFeaturedStickersAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.featuredStickers' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesFeaturedStickersData::class,
        'messages.featuredStickersNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesFeaturedStickersNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.FeaturedStickers');
