...
/**
 * Union DTO base for TL type PremiumSubscriptionOption.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPremiumSubscriptionOptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'premiumSubscriptionOption' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PremiumSubscriptionOptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PremiumSubscriptionOption');
