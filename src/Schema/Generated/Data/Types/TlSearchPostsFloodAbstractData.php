...
/**
 * Union DTO base for TL type SearchPostsFlood.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSearchPostsFloodAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'searchPostsFlood' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SearchPostsFloodData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SearchPostsFlood');
