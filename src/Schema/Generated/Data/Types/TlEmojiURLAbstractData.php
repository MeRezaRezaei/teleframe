...
/**
 * Union DTO base for TL type EmojiURL.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlEmojiURLAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'emojiURL' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\EmojiURLData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for EmojiURL');
