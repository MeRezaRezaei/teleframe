...
/**
 * Union DTO base for TL type InputContact.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputContactAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputPhoneContact' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputPhoneContactData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputContact');
