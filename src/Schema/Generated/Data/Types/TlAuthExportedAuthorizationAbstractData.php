...
/**
 * Union DTO base for TL type auth.ExportedAuthorization.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAuthExportedAuthorizationAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'auth.exportedAuthorization' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAuthExportedAuthorizationData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for auth.ExportedAuthorization');
