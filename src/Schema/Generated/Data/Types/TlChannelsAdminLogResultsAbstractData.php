...
/**
 * Union DTO base for TL type channels.AdminLogResults.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChannelsAdminLogResultsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'channels.adminLogResults' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlChannelsAdminLogResultsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for channels.AdminLogResults');
