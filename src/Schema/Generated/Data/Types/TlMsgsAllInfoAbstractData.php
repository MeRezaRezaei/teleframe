...
/**
 * Union DTO base for TL type MsgsAllInfo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMsgsAllInfoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'msgs_all_info' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MsgsAllInfoData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MsgsAllInfo');
