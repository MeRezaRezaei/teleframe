...
/**
 * Union DTO base for TL type Photo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPhotoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'photo' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PhotoData::class,
        'photoEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PhotoEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Photo');
