...
/**
 * Union DTO base for TL type SearchResultsPosition.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSearchResultsPositionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'searchResultPosition' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SearchResultPositionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SearchResultsPosition');
