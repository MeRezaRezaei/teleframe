...
/**
 * Union DTO base for TL type messages.EmojiGameOutcome.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesEmojiGameOutcomeAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.emojiGameOutcome' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesEmojiGameOutcomeData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.EmojiGameOutcome');
