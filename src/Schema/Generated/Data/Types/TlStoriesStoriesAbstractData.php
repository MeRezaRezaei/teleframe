...
/**
 * Union DTO base for TL type stories.Stories.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStoriesStoriesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stories.stories' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStoriesStoriesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for stories.Stories');
