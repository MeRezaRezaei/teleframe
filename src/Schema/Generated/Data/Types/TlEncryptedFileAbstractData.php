...
/**
 * Union DTO base for TL type EncryptedFile.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlEncryptedFileAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'encryptedFile' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\EncryptedFileData::class,
        'encryptedFileEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\EncryptedFileEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for EncryptedFile');
