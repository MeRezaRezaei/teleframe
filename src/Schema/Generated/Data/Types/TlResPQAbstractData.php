...
/**
 * Union DTO base for TL type ResPQ.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlResPQAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'resPQ' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ResPQData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ResPQ');
