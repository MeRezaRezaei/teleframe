...
/**
 * Union DTO base for TL type InputTheme.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputThemeAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputTheme' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputThemeData::class,
        'inputThemeSlug' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputThemeSlugData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputTheme');
