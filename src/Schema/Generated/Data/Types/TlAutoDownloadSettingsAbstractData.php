...
/**
 * Union DTO base for TL type AutoDownloadSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAutoDownloadSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'autoDownloadSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\AutoDownloadSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for AutoDownloadSettings');
