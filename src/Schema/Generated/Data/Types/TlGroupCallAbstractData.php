...
/**
 * Union DTO base for TL type GroupCall.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlGroupCallAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'groupCall' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GroupCallData::class,
        'groupCallDiscarded' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GroupCallDiscardedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for GroupCall');
