...
/**
 * Union DTO base for TL type help.PeerColorOption.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlHelpPeerColorOptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'help.peerColorOption' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpPeerColorOptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for help.PeerColorOption');
