...
/**
 * Union DTO base for TL type stats.MessageStats.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStatsMessageStatsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stats.messageStats' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStatsMessageStatsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for stats.MessageStats');
