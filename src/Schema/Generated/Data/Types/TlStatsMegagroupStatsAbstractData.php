...
/**
 * Union DTO base for TL type stats.MegagroupStats.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStatsMegagroupStatsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stats.megagroupStats' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStatsMegagroupStatsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for stats.MegagroupStats');
