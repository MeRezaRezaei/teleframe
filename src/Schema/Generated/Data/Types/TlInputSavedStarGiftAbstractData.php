...
/**
 * Union DTO base for TL type InputSavedStarGift.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputSavedStarGiftAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputSavedStarGiftChat' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputSavedStarGiftChatData::class,
        'inputSavedStarGiftSlug' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputSavedStarGiftSlugData::class,
        'inputSavedStarGiftUser' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputSavedStarGiftUserData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputSavedStarGift');
