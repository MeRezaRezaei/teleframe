...
/**
 * Union DTO base for TL type account.PasswordInputSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountPasswordInputSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.passwordInputSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountPasswordInputSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.PasswordInputSettings');
