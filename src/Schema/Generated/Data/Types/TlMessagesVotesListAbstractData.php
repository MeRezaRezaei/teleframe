...
/**
 * Union DTO base for TL type messages.VotesList.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesVotesListAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.votesList' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesVotesListData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.VotesList');
