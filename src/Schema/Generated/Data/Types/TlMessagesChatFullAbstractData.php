...
/**
 * Union DTO base for TL type messages.ChatFull.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesChatFullAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.chatFull' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesChatFullData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.ChatFull');
