...
/**
 * Union DTO base for TL type Username.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlUsernameAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'username' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\UsernameData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Username');
