...
/**
 * Union DTO base for TL type contacts.ResolvedPeer.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlContactsResolvedPeerAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'contacts.resolvedPeer' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlContactsResolvedPeerData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for contacts.ResolvedPeer');
