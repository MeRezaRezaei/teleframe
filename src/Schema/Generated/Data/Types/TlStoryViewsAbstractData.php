...
/**
 * Union DTO base for TL type StoryViews.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStoryViewsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'storyViews' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StoryViewsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StoryViews');
