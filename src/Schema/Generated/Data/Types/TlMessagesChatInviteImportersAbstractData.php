...
/**
 * Union DTO base for TL type messages.ChatInviteImporters.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesChatInviteImportersAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.chatInviteImporters' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesChatInviteImportersData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.ChatInviteImporters');
