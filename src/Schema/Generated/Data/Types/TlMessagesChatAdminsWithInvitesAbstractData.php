...
/**
 * Union DTO base for TL type messages.ChatAdminsWithInvites.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesChatAdminsWithInvitesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.chatAdminsWithInvites' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesChatAdminsWithInvitesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.ChatAdminsWithInvites');
