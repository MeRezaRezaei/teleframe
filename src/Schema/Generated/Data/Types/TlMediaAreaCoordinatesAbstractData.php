...
/**
 * Union DTO base for TL type MediaAreaCoordinates.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMediaAreaCoordinatesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'mediaAreaCoordinates' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MediaAreaCoordinatesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MediaAreaCoordinates');
