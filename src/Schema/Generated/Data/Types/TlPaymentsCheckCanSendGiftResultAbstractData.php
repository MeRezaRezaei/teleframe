...
/**
 * Union DTO base for TL type payments.CheckCanSendGiftResult.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsCheckCanSendGiftResultAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.checkCanSendGiftResultFail' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsCheckCanSendGiftResultFailData::class,
        'payments.checkCanSendGiftResultOk' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsCheckCanSendGiftResultOkData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.CheckCanSendGiftResult');
