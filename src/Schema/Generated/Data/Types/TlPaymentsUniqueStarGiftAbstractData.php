...
/**
 * Union DTO base for TL type payments.UniqueStarGift.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsUniqueStarGiftAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.uniqueStarGift' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsUniqueStarGiftData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.UniqueStarGift');
