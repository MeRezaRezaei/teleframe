...
/**
 * Union DTO base for TL type StarsTopupOption.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarsTopupOptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starsTopupOption' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarsTopupOptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarsTopupOption');
