...
/**
 * Union DTO base for TL type WebDomainException.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlWebDomainExceptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'webDomainException' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\WebDomainExceptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for WebDomainException');
