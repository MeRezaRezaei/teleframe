...
/**
 * Union DTO base for TL type MsgsStateInfo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMsgsStateInfoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'msgs_state_info' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MsgsStateInfoData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MsgsStateInfo');
