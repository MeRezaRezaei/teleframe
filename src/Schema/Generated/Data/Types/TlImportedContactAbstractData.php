...
/**
 * Union DTO base for TL type ImportedContact.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlImportedContactAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'importedContact' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ImportedContactData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ImportedContact');
