...
/**
 * Union DTO base for TL type stories.StoryViews.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStoriesStoryViewsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stories.storyViews' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStoriesStoryViewsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for stories.StoryViews');
