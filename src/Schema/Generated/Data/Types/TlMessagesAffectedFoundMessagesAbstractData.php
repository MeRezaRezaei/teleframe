...
/**
 * Union DTO base for TL type messages.AffectedFoundMessages.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesAffectedFoundMessagesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.affectedFoundMessages' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesAffectedFoundMessagesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.AffectedFoundMessages');
