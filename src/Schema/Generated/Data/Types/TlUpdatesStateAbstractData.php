...
/**
 * Union DTO base for TL type updates.State.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlUpdatesStateAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'updates.state' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlUpdatesStateData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for updates.State');
