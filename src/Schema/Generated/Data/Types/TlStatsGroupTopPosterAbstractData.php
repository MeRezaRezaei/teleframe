...
/**
 * Union DTO base for TL type StatsGroupTopPoster.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStatsGroupTopPosterAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'statsGroupTopPoster' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StatsGroupTopPosterData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StatsGroupTopPoster');
