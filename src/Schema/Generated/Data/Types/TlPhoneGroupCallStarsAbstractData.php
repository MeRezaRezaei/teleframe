...
/**
 * Union DTO base for TL type phone.GroupCallStars.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPhoneGroupCallStarsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'phone.groupCallStars' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPhoneGroupCallStarsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for phone.GroupCallStars');
