...
/**
 * Union DTO base for TL type messages.SearchResultsPositions.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesSearchResultsPositionsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.searchResultsPositions' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesSearchResultsPositionsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.SearchResultsPositions');
