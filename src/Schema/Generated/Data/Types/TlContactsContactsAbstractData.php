...
/**
 * Union DTO base for TL type contacts.Contacts.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlContactsContactsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'contacts.contacts' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlContactsContactsData::class,
        'contacts.contactsNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlContactsContactsNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for contacts.Contacts');
