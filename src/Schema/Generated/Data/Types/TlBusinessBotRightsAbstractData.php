...
/**
 * Union DTO base for TL type BusinessBotRights.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBusinessBotRightsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'businessBotRights' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BusinessBotRightsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BusinessBotRights');
