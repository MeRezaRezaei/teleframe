...
/**
 * Union DTO base for TL type GroupCallParticipant.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlGroupCallParticipantAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'groupCallParticipant' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GroupCallParticipantData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for GroupCallParticipant');
