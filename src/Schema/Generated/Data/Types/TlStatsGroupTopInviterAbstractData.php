...
/**
 * Union DTO base for TL type StatsGroupTopInviter.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStatsGroupTopInviterAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'statsGroupTopInviter' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StatsGroupTopInviterData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StatsGroupTopInviter');
