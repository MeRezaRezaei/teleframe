...
/**
 * Union DTO base for TL type PollAnswerVoters.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPollAnswerVotersAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'pollAnswerVoters' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PollAnswerVotersData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PollAnswerVoters');
