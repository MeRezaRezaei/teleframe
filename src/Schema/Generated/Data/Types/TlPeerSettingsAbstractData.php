...
/**
 * Union DTO base for TL type PeerSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPeerSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'peerSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PeerSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PeerSettings');
