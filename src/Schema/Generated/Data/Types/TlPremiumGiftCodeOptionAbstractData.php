...
/**
 * Union DTO base for TL type PremiumGiftCodeOption.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPremiumGiftCodeOptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'premiumGiftCodeOption' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PremiumGiftCodeOptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PremiumGiftCodeOption');
