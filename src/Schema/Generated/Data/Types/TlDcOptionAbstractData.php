...
/**
 * Union DTO base for TL type DcOption.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlDcOptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'dcOption' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DcOptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for DcOption');
