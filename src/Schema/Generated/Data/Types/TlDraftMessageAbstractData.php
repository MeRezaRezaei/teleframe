...
/**
 * Union DTO base for TL type DraftMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlDraftMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'draftMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DraftMessageData::class,
        'draftMessageEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DraftMessageEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for DraftMessage');
