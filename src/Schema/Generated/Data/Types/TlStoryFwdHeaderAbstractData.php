...
/**
 * Union DTO base for TL type StoryFwdHeader.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStoryFwdHeaderAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'storyFwdHeader' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StoryFwdHeaderData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StoryFwdHeader');
