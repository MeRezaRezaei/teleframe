...
/**
 * Union DTO base for TL type DialogPeer.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlDialogPeerAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'dialogPeer' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DialogPeerData::class,
        'dialogPeerFolder' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DialogPeerFolderData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for DialogPeer');
