...
/**
 * Union DTO base for TL type PaymentFormMethod.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentFormMethodAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'paymentFormMethod' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PaymentFormMethodData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PaymentFormMethod');
