...
/**
 * Union DTO base for TL type SponsoredPeer.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSponsoredPeerAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'sponsoredPeer' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SponsoredPeerData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SponsoredPeer');
