...
/**
 * Union DTO base for TL type account.PaidMessagesRevenue.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountPaidMessagesRevenueAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.paidMessagesRevenue' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountPaidMessagesRevenueData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.PaidMessagesRevenue');
