...
/**
 * Union DTO base for TL type AccountDaysTTL.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountDaysTTLAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'accountDaysTTL' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\AccountDaysTTLData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for AccountDaysTTL');
