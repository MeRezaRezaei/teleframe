...
/**
 * Union DTO base for TL type auth.PasskeyLoginOptions.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAuthPasskeyLoginOptionsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'auth.passkeyLoginOptions' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAuthPasskeyLoginOptionsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for auth.PasskeyLoginOptions');
