...
/**
 * Union DTO base for TL type MessageExtendedMedia.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessageExtendedMediaAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messageExtendedMedia' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MessageExtendedMediaData::class,
        'messageExtendedMediaPreview' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MessageExtendedMediaPreviewData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MessageExtendedMedia');
