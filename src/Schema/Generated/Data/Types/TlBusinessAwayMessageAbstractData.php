...
/**
 * Union DTO base for TL type BusinessAwayMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBusinessAwayMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'businessAwayMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BusinessAwayMessageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BusinessAwayMessage');
