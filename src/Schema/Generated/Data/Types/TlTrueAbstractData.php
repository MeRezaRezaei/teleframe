...
/**
 * Union DTO base for TL type True.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlTrueAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'true' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TrueData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for True');
