...
/**
 * Union DTO base for TL type messages.ExportedChatInvites.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesExportedChatInvitesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.exportedChatInvites' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesExportedChatInvitesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.ExportedChatInvites');
