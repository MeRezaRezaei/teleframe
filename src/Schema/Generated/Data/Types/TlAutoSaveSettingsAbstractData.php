...
/**
 * Union DTO base for TL type AutoSaveSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAutoSaveSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'autoSaveSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\AutoSaveSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for AutoSaveSettings');
