...
/**
 * Union DTO base for TL type EmojiLanguage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlEmojiLanguageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'emojiLanguage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\EmojiLanguageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for EmojiLanguage');
