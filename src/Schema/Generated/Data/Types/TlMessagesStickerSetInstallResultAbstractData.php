...
/**
 * Union DTO base for TL type messages.StickerSetInstallResult.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesStickerSetInstallResultAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.stickerSetInstallResultArchive' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesStickerSetInstallResultArchiveData::class,
        'messages.stickerSetInstallResultSuccess' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesStickerSetInstallResultSuccessData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.StickerSetInstallResult');
