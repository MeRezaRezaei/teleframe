...
/**
 * Union DTO base for TL type AuctionBidLevel.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAuctionBidLevelAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'auctionBidLevel' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\AuctionBidLevelData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for AuctionBidLevel');
