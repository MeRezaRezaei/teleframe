...
/**
 * Union DTO base for TL type chatlists.ExportedInvites.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatlistsExportedInvitesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatlists.exportedInvites' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlChatlistsExportedInvitesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for chatlists.ExportedInvites');
