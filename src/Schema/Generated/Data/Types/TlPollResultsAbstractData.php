...
/**
 * Union DTO base for TL type PollResults.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPollResultsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'pollResults' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PollResultsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PollResults');
