...
/**
 * Union DTO base for TL type ReceivedNotifyMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlReceivedNotifyMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'receivedNotifyMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ReceivedNotifyMessageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ReceivedNotifyMessage');
