...
/**
 * Union DTO base for TL type channels.ChannelParticipant.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChannelsChannelParticipantAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'channels.channelParticipant' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlChannelsChannelParticipantData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for channels.ChannelParticipant');
