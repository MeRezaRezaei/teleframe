...
/**
 * Union DTO base for TL type StarGiftAuctionRound.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarGiftAuctionRoundAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starGiftAuctionRound' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarGiftAuctionRoundData::class,
        'starGiftAuctionRoundExtendable' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarGiftAuctionRoundExtendableData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarGiftAuctionRound');
