...
/**
 * Union DTO base for TL type contacts.TopPeers.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlContactsTopPeersAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'contacts.topPeers' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlContactsTopPeersData::class,
        'contacts.topPeersDisabled' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlContactsTopPeersDisabledData::class,
        'contacts.topPeersNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlContactsTopPeersNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for contacts.TopPeers');
