...
/**
 * Union DTO base for TL type TodoItem.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlTodoItemAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'todoItem' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TodoItemData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for TodoItem');
