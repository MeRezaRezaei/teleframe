...
/**
 * Union DTO base for TL type payments.UniqueStarGiftValueInfo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsUniqueStarGiftValueInfoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.uniqueStarGiftValueInfo' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsUniqueStarGiftValueInfoData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.UniqueStarGiftValueInfo');
