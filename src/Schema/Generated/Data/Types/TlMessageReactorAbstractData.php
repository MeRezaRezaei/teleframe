...
/**
 * Union DTO base for TL type MessageReactor.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessageReactorAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messageReactor' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MessageReactorData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MessageReactor');
