...
/**
 * Union DTO base for TL type messages.StickerSet.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesStickerSetAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.stickerSet' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesStickerSetData::class,
        'messages.stickerSetNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesStickerSetNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.StickerSet');
