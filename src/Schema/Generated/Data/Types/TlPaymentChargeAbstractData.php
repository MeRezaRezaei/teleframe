...
/**
 * Union DTO base for TL type PaymentCharge.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentChargeAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'paymentCharge' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PaymentChargeData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PaymentCharge');
