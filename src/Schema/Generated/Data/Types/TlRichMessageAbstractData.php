...
/**
 * Union DTO base for TL type RichMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlRichMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'richMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\RichMessageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for RichMessage');
