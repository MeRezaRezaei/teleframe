...
/**
 * Union DTO base for TL type Theme.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlThemeAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'theme' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ThemeData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Theme');
