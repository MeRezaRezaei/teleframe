...
/**
 * Union DTO base for TL type DestroySessionRes.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlDestroySessionResAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'destroy_session_none' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DestroySessionNoneData::class,
        'destroy_session_ok' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DestroySessionOkData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for DestroySessionRes');
