...
/**
 * Union DTO base for TL type LangPackDifference.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlLangPackDifferenceAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'langPackDifference' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\LangPackDifferenceData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for LangPackDifference');
