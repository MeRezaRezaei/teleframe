...
/**
 * Union DTO base for TL type payments.SuggestedStarRefBots.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsSuggestedStarRefBotsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.suggestedStarRefBots' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsSuggestedStarRefBotsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.SuggestedStarRefBots');
