...
/**
 * Union DTO base for TL type account.AuthorizationForm.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountAuthorizationFormAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.authorizationForm' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountAuthorizationFormData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.AuthorizationForm');
