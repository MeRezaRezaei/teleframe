...
/**
 * Union DTO base for TL type MissingInvitee.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMissingInviteeAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'missingInvitee' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MissingInviteeData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MissingInvitee');
