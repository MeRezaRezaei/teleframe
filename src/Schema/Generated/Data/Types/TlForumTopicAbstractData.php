...
/**
 * Union DTO base for TL type ForumTopic.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlForumTopicAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'forumTopic' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ForumTopicData::class,
        'forumTopicDeleted' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ForumTopicDeletedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ForumTopic');
