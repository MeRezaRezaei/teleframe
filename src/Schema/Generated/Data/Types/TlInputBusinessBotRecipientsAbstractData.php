...
/**
 * Union DTO base for TL type InputBusinessBotRecipients.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputBusinessBotRecipientsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputBusinessBotRecipients' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputBusinessBotRecipientsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputBusinessBotRecipients');
