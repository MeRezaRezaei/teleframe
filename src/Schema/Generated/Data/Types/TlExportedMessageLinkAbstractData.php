...
/**
 * Union DTO base for TL type ExportedMessageLink.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlExportedMessageLinkAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'exportedMessageLink' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ExportedMessageLinkData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ExportedMessageLink');
