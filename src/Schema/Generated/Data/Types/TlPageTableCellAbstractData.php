...
/**
 * Union DTO base for TL type PageTableCell.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPageTableCellAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'pageTableCell' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PageTableCellData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PageTableCell');
