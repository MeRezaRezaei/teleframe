...
/**
 * Union DTO base for TL type messages.BotCallbackAnswer.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesBotCallbackAnswerAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.botCallbackAnswer' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesBotCallbackAnswerData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.BotCallbackAnswer');
