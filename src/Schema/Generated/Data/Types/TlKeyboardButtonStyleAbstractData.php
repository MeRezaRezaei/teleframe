...
/**
 * Union DTO base for TL type KeyboardButtonStyle.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlKeyboardButtonStyleAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'keyboardButtonStyle' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\KeyboardButtonStyleData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for KeyboardButtonStyle');
