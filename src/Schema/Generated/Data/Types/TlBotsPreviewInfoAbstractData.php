...
/**
 * Union DTO base for TL type bots.PreviewInfo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBotsPreviewInfoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'bots.previewInfo' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlBotsPreviewInfoData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for bots.PreviewInfo');
