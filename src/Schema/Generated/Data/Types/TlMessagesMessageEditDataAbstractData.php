...
/**
 * Union DTO base for TL type messages.MessageEditData.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesMessageEditDataAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.messageEditData' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesMessageEditDataData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.MessageEditData');
