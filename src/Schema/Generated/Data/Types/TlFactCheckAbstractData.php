...
/**
 * Union DTO base for TL type FactCheck.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlFactCheckAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'factCheck' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\FactCheckData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for FactCheck');
