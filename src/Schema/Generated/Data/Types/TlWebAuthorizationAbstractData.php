...
/**
 * Union DTO base for TL type WebAuthorization.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlWebAuthorizationAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'webAuthorization' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\WebAuthorizationData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for WebAuthorization');
