...
/**
 * Union DTO base for TL type KeyboardButtonRow.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlKeyboardButtonRowAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'keyboardButtonRow' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\KeyboardButtonRowData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for KeyboardButtonRow');
