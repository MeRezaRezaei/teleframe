...
/**
 * Union DTO base for TL type TextWithEntities.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlTextWithEntitiesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'textWithEntities' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TextWithEntitiesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for TextWithEntities');
