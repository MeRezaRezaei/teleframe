...
/**
 * Union DTO base for TL type MessagePeerReaction.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagePeerReactionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messagePeerReaction' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MessagePeerReactionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MessagePeerReaction');
