...
/**
 * Union DTO base for TL type BusinessWorkHours.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBusinessWorkHoursAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'businessWorkHours' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BusinessWorkHoursData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BusinessWorkHours');
