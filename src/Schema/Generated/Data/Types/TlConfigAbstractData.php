...
/**
 * Union DTO base for TL type Config.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlConfigAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'config' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ConfigData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Config');
