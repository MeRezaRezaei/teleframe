...
/**
 * Union DTO base for TL type account.ResolvedBusinessChatLinks.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountResolvedBusinessChatLinksAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.resolvedBusinessChatLinks' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountResolvedBusinessChatLinksData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.ResolvedBusinessChatLinks');
