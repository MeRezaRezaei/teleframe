...
/**
 * Union DTO base for TL type ExportedContactToken.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlExportedContactTokenAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'exportedContactToken' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ExportedContactTokenData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ExportedContactToken');
