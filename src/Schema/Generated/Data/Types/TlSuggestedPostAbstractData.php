...
/**
 * Union DTO base for TL type SuggestedPost.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSuggestedPostAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'suggestedPost' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SuggestedPostData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SuggestedPost');
