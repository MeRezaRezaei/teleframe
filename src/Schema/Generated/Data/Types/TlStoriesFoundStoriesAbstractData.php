...
/**
 * Union DTO base for TL type stories.FoundStories.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStoriesFoundStoriesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stories.foundStories' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStoriesFoundStoriesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for stories.FoundStories');
