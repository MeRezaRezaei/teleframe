...
/**
 * Union DTO base for TL type InputWebDocument.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputWebDocumentAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputWebDocument' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputWebDocumentData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputWebDocument');
