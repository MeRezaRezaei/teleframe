...
/**
 * Union DTO base for TL type PublicForward.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPublicForwardAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'publicForwardMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PublicForwardMessageData::class,
        'publicForwardStory' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PublicForwardStoryData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PublicForward');
