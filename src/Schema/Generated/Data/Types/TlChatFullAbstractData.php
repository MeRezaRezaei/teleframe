...
/**
 * Union DTO base for TL type ChatFull.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatFullAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'channelFull' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChannelFullData::class,
        'chatFull' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatFullData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChatFull');
