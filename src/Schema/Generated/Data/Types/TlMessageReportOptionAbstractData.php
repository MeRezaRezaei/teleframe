...
/**
 * Union DTO base for TL type MessageReportOption.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessageReportOptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messageReportOption' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MessageReportOptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MessageReportOption');
