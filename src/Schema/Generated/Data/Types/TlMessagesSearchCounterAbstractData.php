...
/**
 * Union DTO base for TL type messages.SearchCounter.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesSearchCounterAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.searchCounter' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesSearchCounterData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.SearchCounter');
