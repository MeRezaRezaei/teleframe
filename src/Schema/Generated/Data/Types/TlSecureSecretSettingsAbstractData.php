...
/**
 * Union DTO base for TL type SecureSecretSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSecureSecretSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'secureSecretSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SecureSecretSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SecureSecretSettings');
