...
/**
 * Union DTO base for TL type PhoneConnection.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPhoneConnectionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'phoneConnection' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PhoneConnectionData::class,
        'phoneConnectionWebrtc' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PhoneConnectionWebrtcData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PhoneConnection');
