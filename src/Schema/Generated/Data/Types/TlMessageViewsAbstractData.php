...
/**
 * Union DTO base for TL type MessageViews.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessageViewsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messageViews' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MessageViewsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MessageViews');
