...
/**
 * Union DTO base for TL type AiComposeToneExample.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAiComposeToneExampleAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'aiComposeToneExample' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\AiComposeToneExampleData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for AiComposeToneExample');
