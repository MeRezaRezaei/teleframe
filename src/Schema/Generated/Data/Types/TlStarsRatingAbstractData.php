...
/**
 * Union DTO base for TL type StarsRating.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarsRatingAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starsRating' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarsRatingData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarsRating');
