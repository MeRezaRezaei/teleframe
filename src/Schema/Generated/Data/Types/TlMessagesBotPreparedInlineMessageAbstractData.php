...
/**
 * Union DTO base for TL type messages.BotPreparedInlineMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesBotPreparedInlineMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.botPreparedInlineMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesBotPreparedInlineMessageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.BotPreparedInlineMessage');
