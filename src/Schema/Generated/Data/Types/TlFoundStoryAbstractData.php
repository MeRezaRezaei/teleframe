...
/**
 * Union DTO base for TL type FoundStory.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlFoundStoryAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'foundStory' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\FoundStoryData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for FoundStory');
