...
/**
 * Union DTO base for TL type account.AutoSaveSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountAutoSaveSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.autoSaveSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountAutoSaveSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.AutoSaveSettings');
