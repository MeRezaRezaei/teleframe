...
/**
 * Union DTO base for TL type InputThemeSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputThemeSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputThemeSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputThemeSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputThemeSettings');
