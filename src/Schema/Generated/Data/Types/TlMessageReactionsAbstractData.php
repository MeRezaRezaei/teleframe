...
/**
 * Union DTO base for TL type MessageReactions.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessageReactionsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messageReactions' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MessageReactionsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MessageReactions');
