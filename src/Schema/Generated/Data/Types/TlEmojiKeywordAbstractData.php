...
/**
 * Union DTO base for TL type EmojiKeyword.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlEmojiKeywordAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'emojiKeyword' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\EmojiKeywordData::class,
        'emojiKeywordDeleted' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\EmojiKeywordDeletedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for EmojiKeyword');
