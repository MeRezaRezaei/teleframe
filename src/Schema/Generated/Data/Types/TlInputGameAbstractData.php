...
/**
 * Union DTO base for TL type InputGame.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputGameAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputGameID' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputGameIDData::class,
        'inputGameShortName' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputGameShortNameData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputGame');
