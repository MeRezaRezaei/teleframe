...
/**
 * Union DTO base for TL type BusinessRecipients.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBusinessRecipientsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'businessRecipients' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BusinessRecipientsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BusinessRecipients');
