...
/**
 * Union DTO base for TL type RpcError.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlRpcErrorAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'rpc_error' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\RpcErrorData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for RpcError');
