...
/**
 * Union DTO base for TL type StarGiftAuctionUserState.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarGiftAuctionUserStateAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starGiftAuctionUserState' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarGiftAuctionUserStateData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarGiftAuctionUserState');
