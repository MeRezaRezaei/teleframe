...
/**
 * Union DTO base for TL type InputDocument.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputDocumentAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputDocument' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputDocumentData::class,
        'inputDocumentEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputDocumentEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputDocument');
