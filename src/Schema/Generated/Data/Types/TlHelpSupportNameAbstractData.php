...
/**
 * Union DTO base for TL type help.SupportName.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlHelpSupportNameAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'help.supportName' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpSupportNameData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for help.SupportName');
