...
/**
 * Union DTO base for TL type InputBusinessChatLink.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputBusinessChatLinkAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputBusinessChatLink' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputBusinessChatLinkData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputBusinessChatLink');
