...
/**
 * Union DTO base for TL type bots.PopularAppBots.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBotsPopularAppBotsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'bots.popularAppBots' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlBotsPopularAppBotsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for bots.PopularAppBots');
