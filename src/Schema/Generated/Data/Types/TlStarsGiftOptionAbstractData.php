...
/**
 * Union DTO base for TL type StarsGiftOption.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarsGiftOptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starsGiftOption' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarsGiftOptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarsGiftOption');
