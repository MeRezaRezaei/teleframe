...
/**
 * Union DTO base for TL type PhoneCallProtocol.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPhoneCallProtocolAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'phoneCallProtocol' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PhoneCallProtocolData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PhoneCallProtocol');
