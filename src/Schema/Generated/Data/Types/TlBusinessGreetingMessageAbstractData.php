...
/**
 * Union DTO base for TL type BusinessGreetingMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBusinessGreetingMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'businessGreetingMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BusinessGreetingMessageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BusinessGreetingMessage');
