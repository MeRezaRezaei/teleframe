...
/**
 * Union DTO base for TL type fragment.CollectibleInfo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlFragmentCollectibleInfoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'fragment.collectibleInfo' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlFragmentCollectibleInfoData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for fragment.CollectibleInfo');
