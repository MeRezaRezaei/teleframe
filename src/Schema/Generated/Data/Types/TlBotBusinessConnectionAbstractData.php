...
/**
 * Union DTO base for TL type BotBusinessConnection.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBotBusinessConnectionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'botBusinessConnection' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BotBusinessConnectionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BotBusinessConnection');
