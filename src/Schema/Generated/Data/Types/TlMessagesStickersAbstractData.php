...
/**
 * Union DTO base for TL type messages.Stickers.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesStickersAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.stickers' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesStickersData::class,
        'messages.stickersNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesStickersNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.Stickers');
