...
/**
 * Union DTO base for TL type SecureValueHash.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSecureValueHashAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'secureValueHash' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SecureValueHashData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SecureValueHash');
