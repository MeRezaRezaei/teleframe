...
/**
 * Union DTO base for TL type messages.BotApp.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesBotAppAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.botApp' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesBotAppData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.BotApp');
