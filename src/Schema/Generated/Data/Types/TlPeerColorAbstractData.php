...
/**
 * Union DTO base for TL type PeerColor.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPeerColorAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputPeerColorCollectible' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputPeerColorCollectibleData::class,
        'peerColor' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PeerColorData::class,
        'peerColorCollectible' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PeerColorCollectibleData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PeerColor');
