...
/**
 * Union DTO base for TL type DisallowedGiftsSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlDisallowedGiftsSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'disallowedGiftsSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DisallowedGiftsSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for DisallowedGiftsSettings');
