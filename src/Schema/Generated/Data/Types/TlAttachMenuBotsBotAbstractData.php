...
/**
 * Union DTO base for TL type AttachMenuBotsBot.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAttachMenuBotsBotAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'attachMenuBotsBot' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\AttachMenuBotsBotData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for AttachMenuBotsBot');
