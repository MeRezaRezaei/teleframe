...
/**
 * Union DTO base for TL type SecurePlainData.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSecurePlainDataAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'securePlainEmail' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SecurePlainEmailData::class,
        'securePlainPhone' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SecurePlainPhoneData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SecurePlainData');
