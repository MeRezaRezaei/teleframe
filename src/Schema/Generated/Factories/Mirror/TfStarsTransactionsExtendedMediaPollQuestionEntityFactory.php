...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfStarsTransactionsExtendedMediaPollQuestionEntity;

class TfStarsTransactionsExtendedMediaPollQuestionEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfStarsTransactionsExtendedMediaPollQuestionEntity::class;
