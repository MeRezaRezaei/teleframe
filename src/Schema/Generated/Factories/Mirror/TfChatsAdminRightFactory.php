...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfChatsAdminRight;

class TfChatsAdminRightFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfChatsAdminRight::class;
