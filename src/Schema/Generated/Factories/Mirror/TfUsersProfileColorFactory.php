...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfUsersProfileColor;

class TfUsersProfileColorFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfUsersProfileColor::class;
