...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfMessagesReplyTo;

class TfMessagesReplyToFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfMessagesReplyTo::class;
