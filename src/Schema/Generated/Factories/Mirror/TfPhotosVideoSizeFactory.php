...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfPhotosVideoSize;

class TfPhotosVideoSizeFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfPhotosVideoSize::class;
