...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfMessagesReplyMarkupRowsButtonsPeerTypeBotAdminRight;

class TfMessagesReplyMarkupRowsButtonsPeerTypeBotAdminRightFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfMessagesReplyMarkupRowsButtonsPeerTypeBotAdminRight::class;
