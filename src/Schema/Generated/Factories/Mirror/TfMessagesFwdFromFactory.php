...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfMessagesFwdFrom;

class TfMessagesFwdFromFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfMessagesFwdFrom::class;
