...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfDialogFiltersTitleEntity;

class TfDialogFiltersTitleEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfDialogFiltersTitleEntity::class;
