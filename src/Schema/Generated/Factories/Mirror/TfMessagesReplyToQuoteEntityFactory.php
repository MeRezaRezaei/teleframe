...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfMessagesReplyToQuoteEntity;

class TfMessagesReplyToQuoteEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfMessagesReplyToQuoteEntity::class;
