...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfStarsSubscriptionsPhotoAttribute;

class TfStarsSubscriptionsPhotoAttributeFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfStarsSubscriptionsPhotoAttribute::class;
