...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfStarsTransactionsExtendedMediaPollAnswersTextEntity;

class TfStarsTransactionsExtendedMediaPollAnswersTextEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfStarsTransactionsExtendedMediaPollAnswersTextEntity::class;
