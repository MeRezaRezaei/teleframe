...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfAdminLogEventsActionNewBannedRight;

class TfAdminLogEventsActionNewBannedRightFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfAdminLogEventsActionNewBannedRight::class;
