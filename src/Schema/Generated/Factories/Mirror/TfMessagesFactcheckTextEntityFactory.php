...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfMessagesFactcheckTextEntity;

class TfMessagesFactcheckTextEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfMessagesFactcheckTextEntity::class;
