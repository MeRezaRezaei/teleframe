...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfDialogsDraftEntity;

class TfDialogsDraftEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfDialogsDraftEntity::class;
