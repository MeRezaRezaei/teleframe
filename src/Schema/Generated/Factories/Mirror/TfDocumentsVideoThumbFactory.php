...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfDocumentsVideoThumb;

class TfDocumentsVideoThumbFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfDocumentsVideoThumb::class;
