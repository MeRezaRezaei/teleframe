...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfMessagesReplyToReplyFrom;

class TfMessagesReplyToReplyFromFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfMessagesReplyToReplyFrom::class;
