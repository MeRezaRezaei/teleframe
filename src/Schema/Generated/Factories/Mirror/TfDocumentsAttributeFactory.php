...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfDocumentsAttribute;

class TfDocumentsAttributeFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfDocumentsAttribute::class;
