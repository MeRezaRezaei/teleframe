...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfTodoItemsTitleEntity;

class TfTodoItemsTitleEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfTodoItemsTitleEntity::class;
