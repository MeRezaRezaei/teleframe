...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfDialogFiltersPinnedPeer;

class TfDialogFiltersPinnedPeerFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfDialogFiltersPinnedPeer::class;
