...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfUsersColor;

class TfUsersColorFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfUsersColor::class;
