...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfMessagesRichMessageBlock;

class TfMessagesRichMessageBlockFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfMessagesRichMessageBlock::class;
