...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfStarsTransactionsStargiftAttributesMessageEntity;

class TfStarsTransactionsStargiftAttributesMessageEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfStarsTransactionsStargiftAttributesMessageEntity::class;
