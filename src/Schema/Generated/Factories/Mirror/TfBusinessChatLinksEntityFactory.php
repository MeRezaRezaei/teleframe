...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfBusinessChatLinksEntity;

class TfBusinessChatLinksEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfBusinessChatLinksEntity::class;
