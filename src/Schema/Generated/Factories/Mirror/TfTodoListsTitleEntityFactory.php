...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfTodoListsTitleEntity;

class TfTodoListsTitleEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfTodoListsTitleEntity::class;
