...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfTodoListsListTitleEntity;

class TfTodoListsListTitleEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfTodoListsListTitleEntity::class;
