...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfChatsDefaultBannedRight;

class TfChatsDefaultBannedRightFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfChatsDefaultBannedRight::class;
