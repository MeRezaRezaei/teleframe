...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfMessagesEntity;

class TfMessagesEntityFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfMessagesEntity::class;
