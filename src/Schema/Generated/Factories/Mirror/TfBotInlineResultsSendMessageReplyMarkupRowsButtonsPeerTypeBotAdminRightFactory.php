...
use MeRezaRezaei\Teleframe\Schema\Generated\Models\Mirror\TfBotInlineResultsSendMessageReplyMarkupRowsButtonsPeerTypeBotAdminRight;

class TfBotInlineResultsSendMessageReplyMarkupRowsButtonsPeerTypeBotAdminRightFactory extends \Illuminate\Database\Eloquent\Factories\Factory
{
    protected $model = TfBotInlineResultsSendMessageReplyMarkupRowsButtonsPeerTypeBotAdminRight::class;
