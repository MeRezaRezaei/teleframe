...
/**
 * 1:1 gift child — the required StarGift union (starGift | starGiftUnique),
 * flattened; the inner StarGift id is the parent key (documented defer).
 */
final class TfSavedStarGiftGift extends TfChildModel
{
    use AccountScoped;
