...
/**
 * tf_channels_profile_color — 1:1 object child of TfChannel
 * (channel.profile_color, flags.24?PeerColor). Single-ctor PeerColor,
 ...
 */
final class TfChannelsProfileColor extends TfChildModel
{
    use AccountScoped;

    protected $table = 'tf_channels_profile_color';
