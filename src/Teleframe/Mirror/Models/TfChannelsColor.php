...
/**
 * tf_channels_color — 1:1 object child of TfChannel (channel.color,
 * flags.23?PeerColor). Single-ctor PeerColor, constructor-discriminated;
 * the internal colors vectors are deferred to the flat write path.
 *
 ...
 */
final class TfChannelsColor extends TfChildModel
{
    use AccountScoped;

    protected $table = 'tf_channels_color';
