...
/**
 * tf_channels_banned_rights — 1:1 object child of TfChannel
 * (channel.banned_rights, flags.15?ChatBannedRights). Single-ctor
 ...
 */
final class TfChannelsBannedRights extends TfChildModel
{
    use AccountScoped;

    protected $table = 'tf_channels_banned_rights';
