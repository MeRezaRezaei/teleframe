...
/**
 * tf_chats_default_banned_rights — 1:1 object child of TfChat
 * (chat.default_banned_rights, flags.9?ChatBannedRights). Single-ctor
 ...
 */
final class TfChatsDefaultBannedRights extends TfChildModel
{
    use AccountScoped;

    protected $table = 'tf_chats_default_banned_rights';
