...
// Teleframe's UserAccountScope documents, parsed from MadelineProto's
// layer-227 TL files (lines keep their official #ids; no crc guesswork).
//
// Usage: php bin/generate-userscope-schema.php

$sourcesDir = dirname(__DIR__) . '/src/Schema/schema/sources';
$tlFiles = [
...
$targetFile = dirname(__DIR__) . '/src/Core/MTProto/TL/Schema/UserScopeSchema.php';
