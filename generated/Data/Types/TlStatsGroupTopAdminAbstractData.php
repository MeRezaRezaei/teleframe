...
/**
 * Union DTO base for TL type StatsGroupTopAdmin.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStatsGroupTopAdminAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'statsGroupTopAdmin' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StatsGroupTopAdminData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StatsGroupTopAdmin');
