...
/**
 * Union DTO base for TL type messages.TranscribedAudio.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesTranscribedAudioAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.transcribedAudio' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesTranscribedAudioData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.TranscribedAudio');
