...
/**
 * Union DTO base for TL type messages.BotResults.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesBotResultsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.botResults' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesBotResultsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.BotResults');
