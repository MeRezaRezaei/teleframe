...
/**
 * Union DTO base for TL type payments.StarGiftCollections.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsStarGiftCollectionsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.starGiftCollections' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsStarGiftCollectionsData::class,
        'payments.starGiftCollectionsNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsStarGiftCollectionsNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.StarGiftCollections');
