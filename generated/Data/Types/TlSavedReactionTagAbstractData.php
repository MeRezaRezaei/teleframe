...
/**
 * Union DTO base for TL type SavedReactionTag.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSavedReactionTagAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'savedReactionTag' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SavedReactionTagData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SavedReactionTag');
