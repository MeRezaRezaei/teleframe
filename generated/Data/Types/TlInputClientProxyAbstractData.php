...
/**
 * Union DTO base for TL type InputClientProxy.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputClientProxyAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputClientProxy' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputClientProxyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputClientProxy');
