...
/**
 * Union DTO base for TL type InputPasskeyCredential.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputPasskeyCredentialAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputPasskeyCredentialFirebasePNV' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputPasskeyCredentialFirebasePNVData::class,
        'inputPasskeyCredentialPublicKey' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputPasskeyCredentialPublicKeyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputPasskeyCredential');
