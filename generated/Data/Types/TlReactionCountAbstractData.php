...
/**
 * Union DTO base for TL type ReactionCount.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlReactionCountAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'reactionCount' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ReactionCountData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ReactionCount');
