...
/**
 * Union DTO base for TL type FolderPeer.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlFolderPeerAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'folderPeer' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\FolderPeerData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for FolderPeer');
