...
/**
 * Union DTO base for TL type InputQuickReplyShortcut.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputQuickReplyShortcutAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputQuickReplyShortcut' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputQuickReplyShortcutData::class,
        'inputQuickReplyShortcutId' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputQuickReplyShortcutIdData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputQuickReplyShortcut');
