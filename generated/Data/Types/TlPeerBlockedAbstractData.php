...
/**
 * Union DTO base for TL type PeerBlocked.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPeerBlockedAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'peerBlocked' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PeerBlockedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PeerBlocked');
