...
/**
 * Union DTO base for TL type PendingSuggestion.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPendingSuggestionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'pendingSuggestion' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PendingSuggestionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PendingSuggestion');
