...
/**
 * Union DTO base for TL type UserFull.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlUserFullAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'userFull' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\UserFullData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for UserFull');
