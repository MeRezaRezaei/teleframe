...
/**
 * Union DTO base for TL type ContactBirthday.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlContactBirthdayAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'contactBirthday' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ContactBirthdayData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ContactBirthday');
