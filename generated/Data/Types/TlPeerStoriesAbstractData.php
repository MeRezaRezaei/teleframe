...
/**
 * Union DTO base for TL type PeerStories.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPeerStoriesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'peerStories' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PeerStoriesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PeerStories');
