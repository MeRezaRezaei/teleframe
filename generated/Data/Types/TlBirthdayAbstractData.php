...
/**
 * Union DTO base for TL type Birthday.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBirthdayAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'birthday' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BirthdayData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Birthday');
