...
/**
 * Union DTO base for TL type channels.SendAsPeers.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChannelsSendAsPeersAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'channels.sendAsPeers' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlChannelsSendAsPeersData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for channels.SendAsPeers');
