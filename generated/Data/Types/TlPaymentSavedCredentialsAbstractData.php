...
/**
 * Union DTO base for TL type PaymentSavedCredentials.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentSavedCredentialsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'paymentSavedCredentialsCard' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PaymentSavedCredentialsCardData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PaymentSavedCredentials');
