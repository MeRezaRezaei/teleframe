...
/**
 * Union DTO base for TL type SavedContact.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSavedContactAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'savedPhoneContact' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SavedPhoneContactData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SavedContact');
