...
/**
 * Union DTO base for TL type RSAPublicKey.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlRSAPublicKeyAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'rsa_public_key' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\RsaPublicKeyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for RSAPublicKey');
