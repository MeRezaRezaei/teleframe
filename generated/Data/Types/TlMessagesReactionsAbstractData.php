...
/**
 * Union DTO base for TL type messages.Reactions.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesReactionsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.reactions' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesReactionsData::class,
        'messages.reactionsNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesReactionsNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.Reactions');
