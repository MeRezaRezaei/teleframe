...
/**
 * Union DTO base for TL type EncryptedMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlEncryptedMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'encryptedMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\EncryptedMessageData::class,
        'encryptedMessageService' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\EncryptedMessageServiceData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for EncryptedMessage');
