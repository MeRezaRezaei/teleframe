...
/**
 * Union DTO base for TL type SecureRequiredType.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSecureRequiredTypeAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'secureRequiredType' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SecureRequiredTypeData::class,
        'secureRequiredTypeOneOf' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SecureRequiredTypeOneOfData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SecureRequiredType');
