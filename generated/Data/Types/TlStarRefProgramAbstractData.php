...
/**
 * Union DTO base for TL type StarRefProgram.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarRefProgramAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starRefProgram' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarRefProgramData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarRefProgram');
