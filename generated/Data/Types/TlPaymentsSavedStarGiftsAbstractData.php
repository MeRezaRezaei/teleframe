...
/**
 * Union DTO base for TL type payments.SavedStarGifts.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsSavedStarGiftsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.savedStarGifts' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsSavedStarGiftsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.SavedStarGifts');
