...
/**
 * Union DTO base for TL type MaskCoords.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMaskCoordsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'maskCoords' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MaskCoordsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MaskCoords');
