...
/**
 * Union DTO base for TL type Server_DH_Params.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlServerDHParamsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'server_DH_params_fail' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ServerDHParamsFailData::class,
        'server_DH_params_ok' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ServerDHParamsOkData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Server_DH_Params');
