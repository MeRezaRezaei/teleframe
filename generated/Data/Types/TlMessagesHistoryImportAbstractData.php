...
/**
 * Union DTO base for TL type messages.HistoryImport.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesHistoryImportAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.historyImport' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesHistoryImportData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.HistoryImport');
