...
/**
 * Union DTO base for TL type WebDocument.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlWebDocumentAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'webDocument' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\WebDocumentData::class,
        'webDocumentNoProxy' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\WebDocumentNoProxyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for WebDocument');
