...
/**
 * Union DTO base for TL type payments.StarsRevenueAdsAccountUrl.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsStarsRevenueAdsAccountUrlAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.starsRevenueAdsAccountUrl' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsStarsRevenueAdsAccountUrlData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.StarsRevenueAdsAccountUrl');
