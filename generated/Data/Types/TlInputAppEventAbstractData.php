...
/**
 * Union DTO base for TL type InputAppEvent.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputAppEventAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputAppEvent' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputAppEventData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputAppEvent');
