...
/**
 * Union DTO base for TL type AvailableEffect.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAvailableEffectAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'availableEffect' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\AvailableEffectData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for AvailableEffect');
