...
/**
 * Union DTO base for TL type ReadParticipantDate.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlReadParticipantDateAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'readParticipantDate' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ReadParticipantDateData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ReadParticipantDate');
