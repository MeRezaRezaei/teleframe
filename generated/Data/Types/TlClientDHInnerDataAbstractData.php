...
/**
 * Union DTO base for TL type Client_DH_Inner_Data.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlClientDHInnerDataAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'client_DH_inner_data' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ClientDHInnerDataData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Client_DH_Inner_Data');
