...
/**
 * Union DTO base for TL type account.PrivacyRules.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountPrivacyRulesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.privacyRules' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountPrivacyRulesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.PrivacyRules');
