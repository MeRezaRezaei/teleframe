...
/**
 * Union DTO base for TL type ChatInviteImporter.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatInviteImporterAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatInviteImporter' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatInviteImporterData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChatInviteImporter');
