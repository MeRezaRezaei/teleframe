...
/**
 * Union DTO base for TL type InputPhoneCall.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputPhoneCallAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputPhoneCall' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputPhoneCallData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputPhoneCall');
