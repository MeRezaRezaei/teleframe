...
/**
 * Union DTO base for TL type GroupCallMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlGroupCallMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'groupCallMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GroupCallMessageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for GroupCallMessage');
