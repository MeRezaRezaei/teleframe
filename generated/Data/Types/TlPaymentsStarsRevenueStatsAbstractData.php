...
/**
 * Union DTO base for TL type payments.StarsRevenueStats.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsStarsRevenueStatsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.starsRevenueStats' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsStarsRevenueStatsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.StarsRevenueStats');
