...
/**
 * Union DTO base for TL type SponsoredMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSponsoredMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'sponsoredMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SponsoredMessageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SponsoredMessage');
