...
/**
 * Union DTO base for TL type help.PassportConfig.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlHelpPassportConfigAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'help.passportConfig' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpPassportConfigData::class,
        'help.passportConfigNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpPassportConfigNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for help.PassportConfig');
