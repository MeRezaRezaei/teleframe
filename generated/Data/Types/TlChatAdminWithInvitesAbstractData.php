...
/**
 * Union DTO base for TL type ChatAdminWithInvites.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatAdminWithInvitesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatAdminWithInvites' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatAdminWithInvitesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChatAdminWithInvites');
