...
/**
 * Union DTO base for TL type account.SavedRingtone.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountSavedRingtoneAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.savedRingtone' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountSavedRingtoneData::class,
        'account.savedRingtoneConverted' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountSavedRingtoneConvertedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.SavedRingtone');
