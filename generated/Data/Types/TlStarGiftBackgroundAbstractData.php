...
/**
 * Union DTO base for TL type StarGiftBackground.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarGiftBackgroundAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starGiftBackground' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarGiftBackgroundData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarGiftBackground');
