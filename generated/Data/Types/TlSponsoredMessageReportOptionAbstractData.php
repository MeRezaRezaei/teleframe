...
/**
 * Union DTO base for TL type SponsoredMessageReportOption.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSponsoredMessageReportOptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'sponsoredMessageReportOption' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SponsoredMessageReportOptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SponsoredMessageReportOption');
