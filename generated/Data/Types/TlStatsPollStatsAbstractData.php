...
/**
 * Union DTO base for TL type stats.PollStats.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStatsPollStatsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stats.pollStats' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStatsPollStatsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for stats.PollStats');
