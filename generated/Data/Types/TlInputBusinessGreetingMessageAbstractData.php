...
/**
 * Union DTO base for TL type InputBusinessGreetingMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputBusinessGreetingMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputBusinessGreetingMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputBusinessGreetingMessageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputBusinessGreetingMessage');
