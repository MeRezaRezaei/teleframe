...
/**
 * Union DTO base for TL type account.Passkeys.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountPasskeysAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.passkeys' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountPasskeysData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.Passkeys');
