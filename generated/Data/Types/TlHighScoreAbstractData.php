...
/**
 * Union DTO base for TL type HighScore.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlHighScoreAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'highScore' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\HighScoreData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for HighScore');
