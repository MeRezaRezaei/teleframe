...
/**
 * Union DTO base for TL type GeoPoint.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlGeoPointAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'geoPoint' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GeoPointData::class,
        'geoPointEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GeoPointEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for GeoPoint');
