...
/**
 * Union DTO base for TL type contacts.SponsoredPeers.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlContactsSponsoredPeersAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'contacts.sponsoredPeers' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlContactsSponsoredPeersData::class,
        'contacts.sponsoredPeersEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlContactsSponsoredPeersEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for contacts.SponsoredPeers');
