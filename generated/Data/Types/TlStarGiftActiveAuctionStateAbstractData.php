...
/**
 * Union DTO base for TL type StarGiftActiveAuctionState.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarGiftActiveAuctionStateAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starGiftActiveAuctionState' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarGiftActiveAuctionStateData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarGiftActiveAuctionState');
