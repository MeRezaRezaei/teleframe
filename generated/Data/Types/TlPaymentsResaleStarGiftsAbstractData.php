...
/**
 * Union DTO base for TL type payments.ResaleStarGifts.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsResaleStarGiftsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.resaleStarGifts' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsResaleStarGiftsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.ResaleStarGifts');
