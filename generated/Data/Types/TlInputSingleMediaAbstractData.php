...
/**
 * Union DTO base for TL type InputSingleMedia.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputSingleMediaAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputSingleMedia' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputSingleMediaData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputSingleMedia');
