...
/**
 * Union DTO base for TL type WallPaperSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlWallPaperSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'wallPaperSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\WallPaperSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for WallPaperSettings');
