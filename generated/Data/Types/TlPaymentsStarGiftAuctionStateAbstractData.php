...
/**
 * Union DTO base for TL type payments.StarGiftAuctionState.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsStarGiftAuctionStateAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.starGiftAuctionState' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsStarGiftAuctionStateData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.StarGiftAuctionState');
