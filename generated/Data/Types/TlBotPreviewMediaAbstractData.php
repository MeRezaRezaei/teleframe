...
/**
 * Union DTO base for TL type BotPreviewMedia.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBotPreviewMediaAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'botPreviewMedia' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BotPreviewMediaData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BotPreviewMedia');
