...
/**
 * Union DTO base for TL type payments.StarGiftUpgradePreview.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsStarGiftUpgradePreviewAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.starGiftUpgradePreview' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsStarGiftUpgradePreviewData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.StarGiftUpgradePreview');
