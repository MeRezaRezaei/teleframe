...
/**
 * Union DTO base for TL type DecryptedMessageLayer.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlDecryptedMessageLayerAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'decryptedMessageLayer' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DecryptedMessageLayerData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for DecryptedMessageLayer');
