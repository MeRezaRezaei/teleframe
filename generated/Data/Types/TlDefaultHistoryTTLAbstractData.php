...
/**
 * Union DTO base for TL type DefaultHistoryTTL.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlDefaultHistoryTTLAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'defaultHistoryTTL' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DefaultHistoryTTLData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for DefaultHistoryTTL');
