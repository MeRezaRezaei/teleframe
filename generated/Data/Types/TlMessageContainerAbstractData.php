...
/**
 * Union DTO base for TL type MessageContainer.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessageContainerAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'msg_container' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MsgContainerData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MessageContainer');
