...
/**
 * Union DTO base for TL type account.SavedMusicIds.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountSavedMusicIdsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.savedMusicIds' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountSavedMusicIdsData::class,
        'account.savedMusicIdsNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountSavedMusicIdsNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.SavedMusicIds');
