...
/**
 * Union DTO base for TL type Object.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlObjectAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'gzip_packed' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GzipPackedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Object');
