...
/**
 * Union DTO base for TL type ChatBannedRights.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatBannedRightsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatBannedRights' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatBannedRightsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChatBannedRights');
