...
/**
 * Union DTO base for TL type InputRichFile.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputRichFileAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputRichFileDocument' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputRichFileDocumentData::class,
        'inputRichFilePhoto' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputRichFilePhotoData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputRichFile');
