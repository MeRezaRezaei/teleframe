...
/**
 * Union DTO base for TL type messages.ChatInviteJoinResult.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesChatInviteJoinResultAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.chatInviteJoinResultOk' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesChatInviteJoinResultOkData::class,
        'messages.chatInviteJoinResultWebView' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesChatInviteJoinResultWebViewData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.ChatInviteJoinResult');
