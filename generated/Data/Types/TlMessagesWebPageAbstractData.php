...
/**
 * Union DTO base for TL type messages.WebPage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesWebPageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.webPage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesWebPageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.WebPage');
