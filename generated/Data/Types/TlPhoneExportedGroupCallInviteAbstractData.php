...
/**
 * Union DTO base for TL type phone.ExportedGroupCallInvite.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPhoneExportedGroupCallInviteAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'phone.exportedGroupCallInvite' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPhoneExportedGroupCallInviteData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for phone.ExportedGroupCallInvite');
