...
/**
 * Union DTO base for TL type ExportedStoryLink.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlExportedStoryLinkAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'exportedStoryLink' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ExportedStoryLinkData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ExportedStoryLink');
