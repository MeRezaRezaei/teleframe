...
/**
 * Union DTO base for TL type messages.DhConfig.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesDhConfigAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.dhConfig' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesDhConfigData::class,
        'messages.dhConfigNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesDhConfigNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.DhConfig');
