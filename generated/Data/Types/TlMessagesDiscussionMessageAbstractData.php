...
/**
 * Union DTO base for TL type messages.DiscussionMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesDiscussionMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.discussionMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesDiscussionMessageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.DiscussionMessage');
