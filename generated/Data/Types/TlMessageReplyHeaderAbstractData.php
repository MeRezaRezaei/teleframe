...
/**
 * Union DTO base for TL type MessageReplyHeader.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessageReplyHeaderAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messageReplyHeader' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MessageReplyHeaderData::class,
        'messageReplyStoryHeader' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MessageReplyStoryHeaderData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MessageReplyHeader');
