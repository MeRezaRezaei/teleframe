...
/**
 * Union DTO base for TL type messages.FoundStickerSets.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesFoundStickerSetsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.foundStickerSets' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesFoundStickerSetsData::class,
        'messages.foundStickerSetsNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesFoundStickerSetsNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.FoundStickerSets');
