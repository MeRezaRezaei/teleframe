...
/**
 * Union DTO base for TL type payments.ValidatedRequestedInfo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsValidatedRequestedInfoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.validatedRequestedInfo' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsValidatedRequestedInfoData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.ValidatedRequestedInfo');
