...
/**
 * Union DTO base for TL type help.UserInfo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlHelpUserInfoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'help.userInfo' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpUserInfoData::class,
        'help.userInfoEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpUserInfoEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for help.UserInfo');
