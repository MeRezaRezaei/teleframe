...
/**
 * Union DTO base for TL type InlineBotSwitchPM.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInlineBotSwitchPMAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inlineBotSwitchPM' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InlineBotSwitchPMData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InlineBotSwitchPM');
