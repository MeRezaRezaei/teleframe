...
/**
 * Union DTO base for TL type GroupCallParticipantVideo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlGroupCallParticipantVideoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'groupCallParticipantVideo' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GroupCallParticipantVideoData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for GroupCallParticipantVideo');
