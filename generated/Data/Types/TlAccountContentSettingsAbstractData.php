...
/**
 * Union DTO base for TL type account.ContentSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountContentSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.contentSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountContentSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.ContentSettings');
