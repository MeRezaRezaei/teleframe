...
/**
 * Union DTO base for TL type CodeSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlCodeSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'codeSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\CodeSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for CodeSettings');
