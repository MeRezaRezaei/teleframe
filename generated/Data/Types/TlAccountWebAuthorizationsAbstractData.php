...
/**
 * Union DTO base for TL type account.WebAuthorizations.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountWebAuthorizationsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.webAuthorizations' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountWebAuthorizationsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.WebAuthorizations');
