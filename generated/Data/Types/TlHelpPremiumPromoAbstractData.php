...
/**
 * Union DTO base for TL type help.PremiumPromo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlHelpPremiumPromoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'help.premiumPromo' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpPremiumPromoData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for help.PremiumPromo');
