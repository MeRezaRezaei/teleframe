...
/**
 * Union DTO base for TL type Invoice.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInvoiceAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'invoice' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InvoiceData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Invoice');
