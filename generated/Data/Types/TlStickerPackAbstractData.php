...
/**
 * Union DTO base for TL type StickerPack.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStickerPackAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stickerPack' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StickerPackData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StickerPack');
