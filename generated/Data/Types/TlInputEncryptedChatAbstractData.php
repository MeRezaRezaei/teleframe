...
/**
 * Union DTO base for TL type InputEncryptedChat.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputEncryptedChatAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputEncryptedChat' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputEncryptedChatData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputEncryptedChat');
