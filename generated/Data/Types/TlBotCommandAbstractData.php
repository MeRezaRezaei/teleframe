...
/**
 * Union DTO base for TL type BotCommand.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBotCommandAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'botCommand' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BotCommandData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BotCommand');
