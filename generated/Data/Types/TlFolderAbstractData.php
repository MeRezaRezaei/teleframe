...
/**
 * Union DTO base for TL type Folder.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlFolderAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'folder' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\FolderData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Folder');
