...
/**
 * Union DTO base for TL type stats.PublicForwards.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStatsPublicForwardsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stats.publicForwards' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStatsPublicForwardsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for stats.PublicForwards');
