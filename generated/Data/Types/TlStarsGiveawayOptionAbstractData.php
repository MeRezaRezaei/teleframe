...
/**
 * Union DTO base for TL type StarsGiveawayOption.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarsGiveawayOptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starsGiveawayOption' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarsGiveawayOptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarsGiveawayOption');
