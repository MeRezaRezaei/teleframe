...
/**
 * Union DTO base for TL type Null.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlNullAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'null' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\NullData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Null');
