...
/**
 * Union DTO base for TL type stories.CanSendStoryCount.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStoriesCanSendStoryCountAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stories.canSendStoryCount' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStoriesCanSendStoryCountData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for stories.CanSendStoryCount');
