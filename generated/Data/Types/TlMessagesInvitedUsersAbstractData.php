...
/**
 * Union DTO base for TL type messages.InvitedUsers.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesInvitedUsersAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.invitedUsers' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesInvitedUsersData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.InvitedUsers');
