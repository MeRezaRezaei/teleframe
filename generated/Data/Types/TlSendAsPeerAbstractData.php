...
/**
 * Union DTO base for TL type SendAsPeer.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSendAsPeerAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'sendAsPeer' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SendAsPeerData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SendAsPeer');
