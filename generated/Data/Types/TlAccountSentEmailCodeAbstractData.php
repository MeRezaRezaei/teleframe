...
/**
 * Union DTO base for TL type account.SentEmailCode.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountSentEmailCodeAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.sentEmailCode' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountSentEmailCodeData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.SentEmailCode');
