...
/**
 * Union DTO base for TL type contacts.ImportedContacts.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlContactsImportedContactsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'contacts.importedContacts' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlContactsImportedContactsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for contacts.ImportedContacts');
