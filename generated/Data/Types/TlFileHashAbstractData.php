...
/**
 * Union DTO base for TL type FileHash.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlFileHashAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'fileHash' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\FileHashData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for FileHash');
