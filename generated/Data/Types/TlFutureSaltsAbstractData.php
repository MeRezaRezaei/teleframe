...
/**
 * Union DTO base for TL type FutureSalts.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlFutureSaltsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'future_salts' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\FutureSaltsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for FutureSalts');
