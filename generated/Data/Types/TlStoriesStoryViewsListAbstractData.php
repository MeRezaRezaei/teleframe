...
/**
 * Union DTO base for TL type stories.StoryViewsList.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStoriesStoryViewsListAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'stories.storyViewsList' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlStoriesStoryViewsListData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for stories.StoryViewsList');
