...
/**
 * Union DTO base for TL type BotApp.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBotAppAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'botApp' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BotAppData::class,
        'botAppNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BotAppNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BotApp');
