...
/**
 * Union DTO base for TL type SecureData.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSecureDataAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'secureData' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SecureDataData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SecureData');
