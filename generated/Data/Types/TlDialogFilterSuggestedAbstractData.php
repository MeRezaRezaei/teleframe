...
/**
 * Union DTO base for TL type DialogFilterSuggested.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlDialogFilterSuggestedAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'dialogFilterSuggested' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DialogFilterSuggestedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for DialogFilterSuggested');
