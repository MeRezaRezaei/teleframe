...
/**
 * Union DTO base for TL type UserProfilePhoto.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlUserProfilePhotoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'userProfilePhoto' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\UserProfilePhotoData::class,
        'userProfilePhotoEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\UserProfilePhotoEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for UserProfilePhoto');
