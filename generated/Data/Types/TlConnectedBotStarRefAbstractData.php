...
/**
 * Union DTO base for TL type ConnectedBotStarRef.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlConnectedBotStarRefAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'connectedBotStarRef' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ConnectedBotStarRefData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ConnectedBotStarRef');
