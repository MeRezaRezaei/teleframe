...
/**
 * Union DTO base for TL type InputPeerNotifySettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputPeerNotifySettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputPeerNotifySettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputPeerNotifySettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputPeerNotifySettings');
