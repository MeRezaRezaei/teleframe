...
/**
 * Union DTO base for TL type payments.StarsRevenueWithdrawalUrl.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsStarsRevenueWithdrawalUrlAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.starsRevenueWithdrawalUrl' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsStarsRevenueWithdrawalUrlData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.StarsRevenueWithdrawalUrl');
