...
/**
 * Union DTO base for TL type InputGeoPoint.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputGeoPointAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputGeoPoint' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputGeoPointData::class,
        'inputGeoPointEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputGeoPointEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputGeoPoint');
