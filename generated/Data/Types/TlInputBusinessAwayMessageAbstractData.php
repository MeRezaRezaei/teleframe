...
/**
 * Union DTO base for TL type InputBusinessAwayMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputBusinessAwayMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputBusinessAwayMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputBusinessAwayMessageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputBusinessAwayMessage');
