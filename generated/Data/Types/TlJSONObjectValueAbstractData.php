...
/**
 * Union DTO base for TL type JSONObjectValue.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlJSONObjectValueAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'jsonObjectValue' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\JsonObjectValueData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for JSONObjectValue');
