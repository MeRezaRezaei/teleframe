...
/**
 * Union DTO base for TL type help.TermsOfServiceUpdate.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlHelpTermsOfServiceUpdateAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'help.termsOfServiceUpdate' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpTermsOfServiceUpdateData::class,
        'help.termsOfServiceUpdateEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpTermsOfServiceUpdateEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for help.TermsOfServiceUpdate');
