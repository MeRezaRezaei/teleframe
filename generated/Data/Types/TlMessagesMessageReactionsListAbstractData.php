...
/**
 * Union DTO base for TL type messages.MessageReactionsList.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesMessageReactionsListAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.messageReactionsList' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesMessageReactionsListData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.MessageReactionsList');
