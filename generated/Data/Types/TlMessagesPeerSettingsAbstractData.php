...
/**
 * Union DTO base for TL type messages.PeerSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesPeerSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.peerSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesPeerSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.PeerSettings');
