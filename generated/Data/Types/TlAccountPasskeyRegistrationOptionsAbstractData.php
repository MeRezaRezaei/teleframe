...
/**
 * Union DTO base for TL type account.PasskeyRegistrationOptions.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountPasskeyRegistrationOptionsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.passkeyRegistrationOptions' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountPasskeyRegistrationOptionsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.PasskeyRegistrationOptions');
