...
/**
 * Union DTO base for TL type NearestDc.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlNearestDcAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'nearestDc' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\NearestDcData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for NearestDc');
