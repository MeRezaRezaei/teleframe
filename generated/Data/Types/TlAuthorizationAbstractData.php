...
/**
 * Union DTO base for TL type Authorization.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAuthorizationAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'authorization' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\AuthorizationData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Authorization');
