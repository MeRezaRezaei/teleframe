...
/**
 * Union DTO base for TL type Contact.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlContactAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'contact' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ContactData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Contact');
