...
/**
 * Union DTO base for TL type MsgDetailedInfo.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMsgDetailedInfoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'msg_detailed_info' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MsgDetailedInfoData::class,
        'msg_new_detailed_info' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MsgNewDetailedInfoData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MsgDetailedInfo');
