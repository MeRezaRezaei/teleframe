...
/**
 * Union DTO base for TL type BindAuthKeyInner.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBindAuthKeyInnerAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'bind_auth_key_inner' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BindAuthKeyInnerData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BindAuthKeyInner');
