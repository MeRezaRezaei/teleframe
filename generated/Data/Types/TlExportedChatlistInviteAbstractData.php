...
/**
 * Union DTO base for TL type ExportedChatlistInvite.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlExportedChatlistInviteAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'exportedChatlistInvite' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ExportedChatlistInviteData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ExportedChatlistInvite');
