...
/**
 * Union DTO base for TL type FileLocation.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlFileLocationAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'fileLocation' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\FileLocationData::class,
        'fileLocationUnavailable' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\FileLocationUnavailableData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for FileLocation');
