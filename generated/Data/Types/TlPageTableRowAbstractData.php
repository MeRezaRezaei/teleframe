...
/**
 * Union DTO base for TL type PageTableRow.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPageTableRowAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'pageTableRow' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PageTableRowData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PageTableRow');
