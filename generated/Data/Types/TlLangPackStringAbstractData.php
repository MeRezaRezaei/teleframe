...
/**
 * Union DTO base for TL type LangPackString.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlLangPackStringAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'langPackString' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\LangPackStringData::class,
        'langPackStringDeleted' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\LangPackStringDeletedData::class,
        'langPackStringPluralized' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\LangPackStringPluralizedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for LangPackString');
