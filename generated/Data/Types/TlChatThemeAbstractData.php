...
/**
 * Union DTO base for TL type ChatTheme.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatThemeAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatTheme' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatThemeData::class,
        'chatThemeUniqueGift' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatThemeUniqueGiftData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChatTheme');
