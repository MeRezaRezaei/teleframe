...
/**
 * Union DTO base for TL type SecureCredentialsEncrypted.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSecureCredentialsEncryptedAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'secureCredentialsEncrypted' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SecureCredentialsEncryptedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SecureCredentialsEncrypted');
