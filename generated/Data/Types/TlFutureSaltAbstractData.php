...
/**
 * Union DTO base for TL type FutureSalt.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlFutureSaltAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'future_salt' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\FutureSaltData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for FutureSalt');
