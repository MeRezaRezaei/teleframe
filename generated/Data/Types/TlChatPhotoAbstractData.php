...
/**
 * Union DTO base for TL type ChatPhoto.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatPhotoAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatPhoto' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatPhotoData::class,
        'chatPhotoEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatPhotoEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChatPhoto');
