...
/**
 * Union DTO base for TL type PageListOrderedItem.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPageListOrderedItemAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'pageListOrderedItemBlocks' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PageListOrderedItemBlocksData::class,
        'pageListOrderedItemText' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PageListOrderedItemTextData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PageListOrderedItem');
