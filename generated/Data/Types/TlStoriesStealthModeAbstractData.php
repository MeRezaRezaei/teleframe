...
/**
 * Union DTO base for TL type StoriesStealthMode.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStoriesStealthModeAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'storiesStealthMode' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StoriesStealthModeData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StoriesStealthMode');
