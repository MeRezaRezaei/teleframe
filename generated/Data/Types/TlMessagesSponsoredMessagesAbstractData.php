...
/**
 * Union DTO base for TL type messages.SponsoredMessages.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesSponsoredMessagesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.sponsoredMessages' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesSponsoredMessagesData::class,
        'messages.sponsoredMessagesEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesSponsoredMessagesEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.SponsoredMessages');
