...
/**
 * Union DTO base for TL type payments.StarGiftWithdrawalUrl.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsStarGiftWithdrawalUrlAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.starGiftWithdrawalUrl' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsStarGiftWithdrawalUrlData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.StarGiftWithdrawalUrl');
