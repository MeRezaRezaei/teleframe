...
/**
 * Union DTO base for TL type messages.AffectedMessages.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesAffectedMessagesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.affectedMessages' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesAffectedMessagesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.AffectedMessages');
