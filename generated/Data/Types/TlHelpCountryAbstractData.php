...
/**
 * Union DTO base for TL type help.Country.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlHelpCountryAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'help.country' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpCountryData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for help.Country');
