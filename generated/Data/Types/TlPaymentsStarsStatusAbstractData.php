...
/**
 * Union DTO base for TL type payments.StarsStatus.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsStarsStatusAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.starsStatus' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsStarsStatusData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.StarsStatus');
