...
/**
 * Union DTO base for TL type GeoPointAddress.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlGeoPointAddressAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'geoPointAddress' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GeoPointAddressData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for GeoPointAddress');
