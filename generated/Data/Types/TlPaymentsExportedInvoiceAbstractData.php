...
/**
 * Union DTO base for TL type payments.ExportedInvoice.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsExportedInvoiceAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.exportedInvoice' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsExportedInvoiceData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.ExportedInvoice');
