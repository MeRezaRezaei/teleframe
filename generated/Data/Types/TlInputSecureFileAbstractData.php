...
/**
 * Union DTO base for TL type InputSecureFile.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputSecureFileAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputSecureFile' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputSecureFileData::class,
        'inputSecureFileUploaded' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputSecureFileUploadedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputSecureFile');
