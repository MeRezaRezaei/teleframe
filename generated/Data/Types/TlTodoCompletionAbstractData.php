...
/**
 * Union DTO base for TL type TodoCompletion.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlTodoCompletionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'todoCompletion' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TodoCompletionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for TodoCompletion');
