...
/**
 * Union DTO base for TL type StatsURL.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStatsURLAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'statsURL' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StatsURLData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StatsURL');
