...
/**
 * Union DTO base for TL type account.Password.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountPasswordAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.password' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountPasswordData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.Password');
