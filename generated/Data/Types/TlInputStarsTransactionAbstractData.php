...
/**
 * Union DTO base for TL type InputStarsTransaction.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlInputStarsTransactionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'inputStarsTransaction' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\InputStarsTransactionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for InputStarsTransaction');
