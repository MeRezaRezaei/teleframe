...
/**
 * Union DTO base for TL type StarsRevenueStatus.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlStarsRevenueStatusAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'starsRevenueStatus' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\StarsRevenueStatusData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for StarsRevenueStatus');
