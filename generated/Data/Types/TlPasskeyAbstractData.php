...
/**
 * Union DTO base for TL type Passkey.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPasskeyAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'passkey' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PasskeyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Passkey');
