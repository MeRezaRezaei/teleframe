...
/**
 * Union DTO base for TL type account.PasswordSettings.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAccountPasswordSettingsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'account.passwordSettings' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlAccountPasswordSettingsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for account.PasswordSettings');
