...
/**
 * Union DTO base for TL type SecureFile.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSecureFileAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'secureFile' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SecureFileData::class,
        'secureFileEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SecureFileEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SecureFile');
