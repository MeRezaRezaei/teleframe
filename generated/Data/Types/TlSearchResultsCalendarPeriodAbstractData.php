...
/**
 * Union DTO base for TL type SearchResultsCalendarPeriod.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSearchResultsCalendarPeriodAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'searchResultsCalendarPeriod' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SearchResultsCalendarPeriodData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SearchResultsCalendarPeriod');
