...
/**
 * Union DTO base for TL type AvailableReaction.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlAvailableReactionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'availableReaction' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\AvailableReactionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for AvailableReaction');
