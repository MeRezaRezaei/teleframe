...
/**
 * Union DTO base for TL type Game.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlGameAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'game' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GameData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Game');
