...
/**
 * Union DTO base for TL type BusinessBotRecipients.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBusinessBotRecipientsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'businessBotRecipients' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BusinessBotRecipientsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BusinessBotRecipients');
