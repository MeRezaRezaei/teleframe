...
/**
 * Union DTO base for TL type BusinessLocation.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlBusinessLocationAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'businessLocation' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\BusinessLocationData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for BusinessLocation');
