...
/**
 * Union DTO base for TL type premium.MyBoosts.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPremiumMyBoostsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'premium.myBoosts' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPremiumMyBoostsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for premium.MyBoosts');
