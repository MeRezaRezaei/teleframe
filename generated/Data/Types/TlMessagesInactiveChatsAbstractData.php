...
/**
 * Union DTO base for TL type messages.InactiveChats.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesInactiveChatsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.inactiveChats' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesInactiveChatsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.InactiveChats');
