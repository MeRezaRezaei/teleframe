...
/**
 * Union DTO base for TL type ChannelLocation.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChannelLocationAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'channelLocation' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChannelLocationData::class,
        'channelLocationEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChannelLocationEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChannelLocation');
