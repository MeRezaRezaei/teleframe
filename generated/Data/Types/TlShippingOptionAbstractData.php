...
/**
 * Union DTO base for TL type ShippingOption.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlShippingOptionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'shippingOption' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ShippingOptionData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ShippingOption');
