...
/**
 * Union DTO base for TL type help.AppConfig.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlHelpAppConfigAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'help.appConfig' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpAppConfigData::class,
        'help.appConfigNotModified' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlHelpAppConfigNotModifiedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for help.AppConfig');
