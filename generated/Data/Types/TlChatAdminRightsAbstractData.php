...
/**
 * Union DTO base for TL type ChatAdminRights.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatAdminRightsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatAdminRights' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatAdminRightsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChatAdminRights');
