...
/**
 * Union DTO base for TL type PostAddress.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPostAddressAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'postAddress' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\PostAddressData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for PostAddress');
