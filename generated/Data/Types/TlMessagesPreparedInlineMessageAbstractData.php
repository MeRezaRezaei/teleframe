...
/**
 * Union DTO base for TL type messages.PreparedInlineMessage.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessagesPreparedInlineMessageAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messages.preparedInlineMessage' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlMessagesPreparedInlineMessageData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for messages.PreparedInlineMessage');
