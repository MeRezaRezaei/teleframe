...
/**
 * Union DTO base for TL type chatlists.ChatlistInvite.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatlistsChatlistInviteAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatlists.chatlistInvite' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlChatlistsChatlistInviteData::class,
        'chatlists.chatlistInviteAlready' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlChatlistsChatlistInviteAlreadyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for chatlists.ChatlistInvite');
