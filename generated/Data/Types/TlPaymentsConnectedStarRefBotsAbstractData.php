...
/**
 * Union DTO base for TL type payments.ConnectedStarRefBots.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPaymentsConnectedStarRefBotsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'payments.connectedStarRefBots' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPaymentsConnectedStarRefBotsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for payments.ConnectedStarRefBots');
