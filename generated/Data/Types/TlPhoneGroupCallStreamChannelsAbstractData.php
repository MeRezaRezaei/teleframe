...
/**
 * Union DTO base for TL type phone.GroupCallStreamChannels.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlPhoneGroupCallStreamChannelsAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'phone.groupCallStreamChannels' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlPhoneGroupCallStreamChannelsData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for phone.GroupCallStreamChannels');
