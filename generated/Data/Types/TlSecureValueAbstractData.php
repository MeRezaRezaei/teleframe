...
/**
 * Union DTO base for TL type SecureValue.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlSecureValueAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'secureValue' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\SecureValueData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for SecureValue');
