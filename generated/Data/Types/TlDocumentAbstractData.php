...
/**
 * Union DTO base for TL type Document.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlDocumentAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'document' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DocumentData::class,
        'documentEmpty' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\DocumentEmptyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for Document');
