...
/**
 * Union DTO base for TL type ChatInvite.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatInviteAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatInvite' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatInviteData::class,
        'chatInviteAlready' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatInviteAlreadyData::class,
        'chatInvitePeek' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\ChatInvitePeekData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for ChatInvite');
