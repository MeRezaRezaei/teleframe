...
/**
 * Union DTO base for TL type MessageReplies.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMessageRepliesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'messageReplies' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MessageRepliesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MessageReplies');
