...
/**
 * Union DTO base for TL type QuickReply.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlQuickReplyAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'quickReply' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\QuickReplyData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for QuickReply');
