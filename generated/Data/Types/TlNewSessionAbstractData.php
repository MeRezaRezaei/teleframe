...
/**
 * Union DTO base for TL type NewSession.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlNewSessionAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'new_session_created' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\NewSessionCreatedData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for NewSession');
