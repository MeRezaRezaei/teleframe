...
/**
 * Union DTO base for TL type MsgsAck.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlMsgsAckAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'msgs_ack' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\MsgsAckData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for MsgsAck');
