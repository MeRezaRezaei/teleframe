...
/**
 * Union DTO base for TL type chatlists.ChatlistUpdates.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlChatlistsChatlistUpdatesAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'chatlists.chatlistUpdates' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\TlChatlistsChatlistUpdatesData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for chatlists.ChatlistUpdates');
