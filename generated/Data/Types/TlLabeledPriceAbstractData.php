...
/**
 * Union DTO base for TL type LabeledPrice.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlLabeledPriceAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'labeledPrice' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\LabeledPriceData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for LabeledPrice');
