...
/**
 * Union DTO base for TL type GroupCallDonor.
 *
 * @method static static hydrate(array $payload)
 */
abstract class TlGroupCallDonorAbstractData extends Data
{
    /** @var array<string, class-string<self>> */
    protected const DISPATCH = [
        'groupCallDonor' => \MeRezaRezaei\Teleframe\Schema\Generated\Data\Types\GroupCallDonorData::class,
    ];
    ...
    public static function hydrate(array $payload): static
    {
        $class = static::DISPATCH[$payload['_']]
            ?? throw new \InvalidArgumentException('Unknown constructor ' . $payload['_'] . ' for GroupCallDonor');
