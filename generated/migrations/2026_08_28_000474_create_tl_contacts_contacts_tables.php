...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('tl_contacts_contacts_contacts__contacts', function (Blueprint $table) {
            ...
            $table->foreign('parent_id', 'fk_51dec9116383b58a40b520ce')->references('id')->on('tl_contacts_contacts_contacts')->cascadeOnDelete();
        ...
        Schema::create('tl_contacts_contacts_contacts__users', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('parent_id');
            $table->foreign('parent_id', 'fk_47039c7d4d6887afd35857d5')->references('id')->on('tl_contacts_contacts_contacts')->cascadeOnDelete();
            $table->bigInteger('idx');
            $table->bigInteger('value_id')->nullable();
            $table->bigInteger('account_id');
