...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('tl_stats_megagroup_stats_megagroup_stats', function (Blueprint $table) {
            ...
            $table->bigInteger('posters')->nullable();
            ...
            $table->bigInteger('members_graph')->nullable();
            $table->index('members_graph', 'ix_478570888ef76f048a257011');
            $table->bigInteger('new_members_by_source_graph')->nullable();
            ...
            $table->bigInteger('messages_graph')->nullable();
            $table->index('messages_graph', 'ix_83b043fd9a609f8a1478d450');
            $table->bigInteger('actions_graph')->nullable();
            ...
            $table->bigInteger('weekdays_graph')->nullable();
            $table->index('weekdays_graph', 'ix_17392ce580ad1ab33aaddc77');
            $table->bigInteger('account_id');
            $table->timestamps();
            $table->index('constructor_id', 'ix_429293dfc2ec12fcf8467d6b');
