...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('tl_web_page_attribute', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->index('constructor_id', 'ix_02c6b7706aa215899c80a001');
            $table->index('account_id', 'ix_baa896d82ef56225345d83a4');
        });
        ...
        Schema::create('tl_web_page_attribute_web_page_attribute_story', function (Blueprint $table) {
            ...
            $table->unique(['account_id', 'peer', 'tl_id'], 'ux_12061f5b04cf78fe45dd');
        });
