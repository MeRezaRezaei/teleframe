...
final class TlHelpPassportConfigPassportConfig extends TlAnchorModel
{
    ...
    public function countriesLangs(): BelongsTo
    {
        return $this->belongsTo(TlDataJSON::class, 'countries_langs');
    }
}
