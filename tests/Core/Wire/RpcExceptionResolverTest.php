...
namespace MeRezaRezaei\Teleframe\Core\Tests\Wire;

use MeRezaRezaei\Teleframe\Core\Exceptions\DcMigrationException;
use MeRezaRezaei\Teleframe\Core\Exceptions\Rpc\ApiIdException;
...
class RpcExceptionResolverTest extends TestCase
{
    ...
    {
        $this->assertSame(
            \MeRezaRezaei\Teleframe\Core\MTProto\Connection\EncryptedConnection::LAYER,
            \MeRezaRezaei\Teleframe\Core\Exceptions\Rpc\RpcErrorCatalog::LAYER
        );
        $this->assertGreaterThan(700, count(\MeRezaRezaei\Teleframe\Core\Exceptions\Rpc\RpcErrorCatalog::descriptions()));
    }
    ...
    public function testParameterizedMatchesWorkWithoutRegex(): void
    {
        ...
        $this->assertNotNull(\MeRezaRezaei\Teleframe\Core\Exceptions\Rpc\RpcErrorCatalog::lookup('SLOWMODE_WAIT_30'));
        ...
        $this->assertNull(\MeRezaRezaei\Teleframe\Core\Exceptions\Rpc\RpcErrorCatalog::lookup('SLOWMODE_WAIT_3O')); // letter O, not zero
    }
}
