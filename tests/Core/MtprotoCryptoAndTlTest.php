...
namespace MeRezaRezaei\Teleframe\Core\Tests;
...
class MtprotoCryptoAndTlTest extends TestCase
{
    ...
    public function testPasswordCalculatorSrpProof(): void
    {
        ...
        $proof = \MeRezaRezaei\Teleframe\Core\MTProto\Crypto\PasswordCalculator::computeSrpProof(
            $accountPassword,
    ...
    public function testMTProtoPacketCodecEncryptionAndDecryption(): void
    {
        ...
        $packet = \MeRezaRezaei\Teleframe\Core\MTProto\Crypto\PacketCodec::encryptPacket(
            payload: $payload,
            authKey: $authKey,
            sessionId: $sessionId,
        ...
        $decrypted = \MeRezaRezaei\Teleframe\Core\MTProto\Crypto\PacketCodec::decryptPacket(
            $packet,
            $authKey,
            fromServer: false
        );
    ...
    {
        $userInput = \MeRezaRezaei\Teleframe\Core\Types\InputUser::user(12345, 123456789012345678);
        ...
        $channelInput = \MeRezaRezaei\Teleframe\Core\Types\InputChannel::channel(67890, 876543210987654321);
        ...
        $fileInput = \MeRezaRezaei\Teleframe\Core\Types\InputFile::file(111, 4, 'photo.jpg', 'md5_sum');
        $this->assertEquals('inputFile', $fileInput['_']);
        $this->assertEquals(4, $fileInput['parts']);

        $bigFileInput = \MeRezaRezaei\Teleframe\Core\Types\InputFile::big(222, 100, 'video.mp4');
    ...
    public function testDecryptPacketRejectsSessionIdMismatch(): void
    {
        ...
        \MeRezaRezaei\Teleframe\Core\MTProto\Crypto\PacketCodec::decryptPacket(
            $packet,
            $authKey,
            fromServer: false,
    ...
    public function testDecryptPacketRejectsZeroMessageId(): void
    {
        ...
        \MeRezaRezaei\Teleframe\Core\MTProto\Crypto\PacketCodec::decryptPacket($packet, $authKey, fromServer: false);
    }
    ...
    public function testDecryptPacketAcceptsMessageIdWithinLeeway(): void
    {
        ...
        $decrypted = \MeRezaRezaei\Teleframe\Core\MTProto\Crypto\PacketCodec::decryptPacket($packet, $authKey, fromServer: false);
    ...
    public function testPasswordCalculatorRejectsSrpBGreaterOrEqualToP(): void
    {
        ...
        \MeRezaRezaei\Teleframe\Core\MTProto\Crypto\PasswordCalculator::computeSrpProof($accountPassword, 'pw');
    }
    ...
    public function testPasswordCalculatorRejectsZeroU(): void
    {
        ...
        \MeRezaRezaei\Teleframe\Core\MTProto\Crypto\PasswordCalculator::assertSrpScalarsValid(
