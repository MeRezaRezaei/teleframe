...
use MeRezaRezaei\Teleframe\Schema\Mirror\MirrorCtorSplitter;
use MeRezaRezaei\Teleframe\Tests\Schema\TestCase;

final class MirrorCtorSplitterTest extends TestCase
{
    ...
    public function test_message_service_is_synthesised(): void
    {
        ...
        $out = (new MirrorCtorSplitter($scheme))->apply($this->catalog());
